...
typedef struct model
{
	...
	animation anim;//map or array or something
	GLuint vertexbuffer;
	GLuint uvbuffer;
	GLuint normalbuffer;
} model;
...
/*
@todo 
separate this into respacker, will make it much neater to separate nasty fbx code
and just work with real data in the engine
wont make building any longer really
*/
	using namespace std;
	model *f=new model;
	f->poly_type=3;
